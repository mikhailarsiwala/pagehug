# Rename the store to MarkMyPlace

## Changes
- Replace Pagehug with MarkMyPlace across the header, footer, store pages, descriptions, and page titles.
...
- Confirm the homepage and mobile header display the new name cleanly.
- Confirm cart and checkout still work and the site has no build errors.
